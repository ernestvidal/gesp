...
<div class="pedido-form">
            ...
            <div id="cliente" class="col-md-6 well">
                <div class="col-md-12">
                    ...
                    $form->field($model, 'cliente_id')->dropDownList(
                            ArrayHelper::map(Identidad::findAll(['identidad_role' => ['PROVEEDOR', 'AMBOS']]), 'identidad_id', 'identidad_nombre'), ['prompt' => 'A quien se va a facturar...', 'id' => 'cliente_id', 'class' => 'form-control'])
                    ?>
                </div>
            </div>
        </div>
    ...
    <div id="pedido_cos" class="well">
        ...
        <div class="row">
            <div class="col-md-2">
                <button title="Nueva" class="btn btn-sm btn-primary" id="add_item_line">
                    <span class="glyphicon glyphicon-plus-sign"></span>
                    <span class="hidden-sm">&nbsp;Nueva línea</span>
                </button>
            </div>
        </div>
    </div>
