    ...
    <div id="pedido_cos" class="well">
        ...
        <div id="item_line">
               ...
               for ($i = 0; $i < $count ; $i++)
              {
                ...
                echo "<input type='text' name='PedidoItem[$i][item_cantidad]' id='item_cantidad_" . $i . "'class='form-control text-right' value='" . $model['pedidoitems'][$i]['item_cantidad'] . "'  >";
                echo "</div>";

                echo "<div class='col-md-5'>";
                echo "<textarea name='PedidoItem[$i][item_descripcion]' id='item_descripcion_" . $i . "' class='form-control'>" . $model['pedidoitems'][$i]['item_descripcion'] . "</textarea>";
                echo "</div>";

                echo "<div class='col-md-2'>";
                echo "<input type='text' name='PedidoItem[$i][item_precio]' id='item_precio_" . $i . "' class='form-control text-right' value=" . $model['pedidoitems'][$i]['item_precio'] . " >";
                echo "</div>";
