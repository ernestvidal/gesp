    ...
    <table id="content" class="table table-bordered">
        ...
        <tfoot>
            ...
            <tr>
                <td style="border-color: white;"></td>
                <td style="border-bottom-color: white;"></td>
                <td>Dto.<?= " " . $model['factura_rate_descuento']. "%"; ?></td>
                <td class="text-right"><?= number_format($importe_descuento, 2,',','.') ?></td>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <td style="border-bottom-color: white;"></td>
                <td>B. Imponible</td>
                <td class="text-right"><?= number_format($base_imponible, 2,',','.') ?></td>
            </tr>
            ...
            <tr>
                <td style="border-color: white;"></td>
                <td style="border-bottom-color: white;"></td>
                <td>Iva<?= " " . $model['factura_rate_iva']. "%"; ?></td>
                <td class="text-right"><?= number_format($importe_iva, 2,',','.') ?></td>
            </tr>
            ...
            <?php if ($model['factura_rate_irpf']<>0){ ?>
                <tr>
                    <td style="border-color: white;"></td>
                    <td style="border-bottom-color: white;"></td>
                    <td>Irpf<?= " " . $model['factura_rate_irpf']. "%"; ?></td>
                    <td class="text-right"><?= number_format($importe_irpf, 2,',','.')  ?></td>
                </tr>
            <?php } ?>
            <tr>
                <td style="border-color: white;"></td>
                ...
                <td class="text-right"><strong><?= number_format($base_imponible + $importe_iva - $importe_irpf, 2, ',','.')  ?></strong></td>
            </tr>
        </tfoot>
    </table>
