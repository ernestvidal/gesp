    ...
    <div id="factura_cos" class="well">
        ...
        <div id="item_line">
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                echo "<input type='text' name='FacturaItem[$i][item_cantidad]' id='item_cantidad_" . $i . "'class='form-control text-right' value='" . $model['proformaitems'][$i]['item_cantidad'] . "'  >";
                echo "</div>";

                echo "<div class='col-md-5'>";
                echo "<textarea name='FacturaItem[$i][item_descripcion]' id='item_descripcion_" . $i . "' class='form-control'>" . $model['proformaitems'][$i]['item_descripcion'] . "</textarea>";
                echo "</div>";

                echo "<div class='col-md-2'>";
                echo "<input type='text' name='FacturaItem[$i][item_precio]' id='item_precio_" . $i . "' class='form-control text-right' value=" . $model['proformaitems'][$i]['item_precio'] . " >";
                echo "</div>";
