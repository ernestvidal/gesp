 ...
 * @property string $pedido_factura_num
...
class Pedidocliente extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['forma_pago', 'pedido_plazo_entrega', 'pedido_validez', 'pedido_free_one', 'pedido_free_two', 'pedido_factura_num'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pedido_factura_num' => 'Pedido Factura Num',
